...
在执行以下命令前，请设置 `MMDEPLOY_DIR` 为您的 `MMDeploy` 根目录（例如 `~/dev/mmdeploy`）。
预训练权重下载于 [yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth](https://download.openmmlab.com/mmyolo/v0/yolov5/yolov5_s-v61_syncbn_fast_8xb16-300e_coco/yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth) ，保存在本地的 `${MMDEPLOY_DIR}/yolov5s.pth`。
